import { Stack, FormControl, Text, FormLabel, Tooltip, Input, Button, useDisclosure, Modal, ModalOverlay, useColorModeValue,ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Alert, AlertDescription, AlertIcon, AlertTitle, Box, CloseButton, Icon, Table, Tbody, Td, Th, Thead, Tr, VStack } from "@chakra-ui/react";
    ...
    return (
        <Fragment>
            <Stack spacing={4} direction="column" align="flex-start">
                ...
                <FormControl>
                    <FormLabel htmlFor="cpfCnpj">CpfCnpj</FormLabel>
                    <Input
                        id="cpfCnpj"
                        onChange={(event) => {
...
export const SearchClient = ({ setClientId }) => {
    ...
    return (
        <>
            <Button onClick={onOpen} colorScheme="blue" marginTop={"6%"}> Buscar Cliente</Button>

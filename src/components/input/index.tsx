...
const CustomInput: React.FC<CustomInputProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center rounded-md shadow-lg ${
          type === "radio"
        ...
        <input
          ...
          ${
            type === "radio"
              ...
              : type === "checkbox"
              ? "w-5 h-5 cursor-pointer appearance-none rounded-md bg-[#3A3A3A] border border-[#ddd] checked:bg-[#9D54BD] checked:border-none"
              : "w-full bg-[#3A3A3A] text-white text-left rounded-r-md focus:outline-none focus:bg-[#3A3A3A] border-none active:bg-[#3A3A3A]"
          }
          `}
